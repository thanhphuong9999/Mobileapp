...
public class TabletAdapter extends BaseAdapter {
    ...
    public TabletAdapter(Context context, ArrayList<Sanpham> arrayListnon) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            convertView=inflater.inflate(R.layout.chitiet_tablet,null);
            ...
            viewHolder= (TabletAdapter.ViewHolder) convertView.getTag();
        }
