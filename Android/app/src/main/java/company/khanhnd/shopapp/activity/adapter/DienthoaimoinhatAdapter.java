...
import company.khanhnd.shopapp.activity.activity.ChiTietSanPham;
import company.khanhnd.shopapp.activity.model.Sanpham;
import company.khanhnd.shopapp.activity.ultil.checkconnect;

public class DienthoaimoinhatAdapter extends RecyclerView.Adapter<DienthoaimoinhatAdapter.ITemHolder> {
    Context context;
    ArrayList<Sanpham> arraysanpham;

    public DienthoaimoinhatAdapter(Context context, ArrayList<Sanpham> arraysanpham) {
