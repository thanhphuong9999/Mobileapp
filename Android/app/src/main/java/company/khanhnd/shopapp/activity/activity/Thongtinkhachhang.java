                                ...
                                StringRequest request = new StringRequest(Request.Method.POST, Server.duongDanChiTietDonHang, new Response.Listener<String>() {
                                    ...
                                    public void onResponse(String response) {
                                        ...
                                        if(response!=null) {
                                            ...
                                            checkconnect.ShowToast_Short(getApplicationContext(),"Bạn đã thêm thông tin mua hàng thành công");
                                        }else{
...
//                                        int madonhang1 = Integer.parseInt(madonhang);
                                        for(int i=0;i<MainActivity.manggiohang.size();i++)
                                        {
                                            JSONObject jsonObject = new JSONObject();
                                            try {
//                                                Log.d("madonhang222", String.valueOf(madonhang1));
                                        ...
                                        hashMap.put("madonhang1",madonhang);
                                        return hashMap;
                                    }
                                };
                                queue.add(request);
    ...
    private void anhxa() {
        ...
        eddiachi=findViewById(R.id.diachidathang);
