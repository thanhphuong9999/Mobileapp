...
import company.khanhnd.shopapp.activity.model.Account;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void addControls() {
        edtFullName=  findViewById(R.id.txtNameDK);
     ...
     */
    private void registerUser(final String fullname,final String username, final String password, final String email) {

        if (checkEditText(edtFullName)&& checkEditText(edtUserName) && checkEditText(edtPassWord) && checkEditText(edtEmail) && isValidEmail(email)) {
            pDialog.show();
